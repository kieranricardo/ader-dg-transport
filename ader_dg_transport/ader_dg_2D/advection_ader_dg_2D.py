...
class AdvectionAderDG2D(BaseADERDG2D):
    ...
    def __init__(self, xlim, ylim, nx, ny, poly_order, cx, cy, dt=None, cfl=None):
        ...
        self.Mx = (Dt + self.x_cfl * Dx + self.y_cfl * Dy) + first_space_integral
        self.Mx += self.x_cfl * xm_integral
        self.Mx -= self.x_cfl * xp_integral
        self.Mx_lu = lu_factor(self.Mx)

        self.My = (Dt + self.x_cfl * Dx + self.y_cfl * Dy) + first_space_integral
        self.My += self.y_cfl * ym_integral
        self.My -= self.y_cfl * yp_integral
        self.My_lu = lu_factor(self.My)

        self.M = (Dt + self.x_cfl * Dx + self.y_cfl * Dy) + first_space_integral
        self.M += self.x_cfl * xm_integral
        self.M += self.y_cfl * ym_integral
        self.M -= self.x_cfl * xp_integral
        self.M -= self.y_cfl * yp_integral
